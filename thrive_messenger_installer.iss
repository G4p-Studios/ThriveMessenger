...
#define MyAppVersion "2026 Alpha 12"
...
AppId={{B8EEB603-E6F8-454E-8ADA-14206E2AF1DD}
AppName={#MyAppName}
...
[Files]
Source: "C:\git\ThriveMessenger\dist\thrive_messenger\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
